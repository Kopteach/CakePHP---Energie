 ...
 * @method \App\Model\Entity\Relef newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Relef[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Relef|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Relef patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Relef[] patchEntities($entities, array $data, array $options = [])
...
class RelevesTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['id'], 'Sites'));
