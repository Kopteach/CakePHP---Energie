...
* Transports Model
*
* @property \Cake\ORM\Association\BelongsTo $ProducerSites
* @property \Cake\ORM\Association\BelongsTo $ConsumerSites
*
...
class TransportsTable extends Table
{
  ...
  */
  public function initialize(array $config)
  {
    ...
    $this->belongsTo('Sites', [
      'foreignKey' => 'producer_site_id',
      'foreignKey' => 'consumer_site_id',
      'joinType' => 'INNER'
    ]);
  }
  ...
  */
  public function validationDefault(Validator $validator)
  {
    ...
    $validator
    ->integer('debit_max')
    ->requirePresence('debit_max', 'create')
    ->notEmpty('debit_max');
